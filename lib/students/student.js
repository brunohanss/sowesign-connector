    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                error_3 = _d.sent();
                console.log('Error --->');
                console.log((_a = error_3.response) === null || _a === void 0 ? void 0 : _a.data.messages.errors.body.toString());
                return [2 /*return*/, {
                        isError: true,
                        message: 'Could not edit or create student',
                        details: ((_b = error_3.response) === null || _b === void 0 ? void 0 : _b.data.messages.errors.body)
                            ? (_c = error_3.response) === null || _c === void 0 ? void 0 : _c.data.messages.errors.body.toString()
                            : error_3,
                    }];
            case 3: return [2 /*return*/];
        }
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                error_4 = _d.sent();
                console.log('Error --->');
                console.log((_a = error_4.response) === null || _a === void 0 ? void 0 : _a.data.messages.errors.body.toString());
                return [2 /*return*/, {
                        isError: true,
                        message: 'Could not delete student',
                        details: ((_b = error_4.response) === null || _b === void 0 ? void 0 : _b.data.messages.errors.body)
                            ? (_c = error_4.response) === null || _c === void 0 ? void 0 : _c.data.messages.errors.body.toString()
                            : error_4,
                    }];
            case 3: return [2 /*return*/];
        }
